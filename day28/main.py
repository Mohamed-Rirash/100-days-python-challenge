...
# ---------------------------- UI SETUP ------------------------------- #
window = Tk()
window.title("Pimodoro")
window.config(padx=100,pady=50,bg=YELLOW)


timer_lable = Label(text="Timer",fg=GREEN,bg=YELLOW,font=(FONT_NAME ,25,"normal"))
...
check_label = Label(fg=GREEN,bg=YELLOW,font=(FONT_NAME ,25,"normal"))
check_label.grid(column=1 ,row=3)


start_reset = Button(text="Reset",command=reset_timer)
